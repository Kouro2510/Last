...
function New() {
    ...
    const handleSaveUser = async (e) => {
        ...
        if (res && res.errCode === 0) {
            ...
            if(state.role==="Customers"){
                navigate(config.routes.customer);
            }
            else {
                                   ...
                                   <div className={` ${cx('form-input')}`}>
                                       <div>
                                           ...
                                           <select name="role" className="dark:text-gray-900" onChange={(e) => handleOnchangeInput(e, 'role')} required>
                                               ...
                                               <option className="dark:text-gray-900" value="Employee"> Employee </option>
                                               <option className="dark:text-gray-900" value="Customer"> Customers </option>
                                           </select>
                                       </div>
                                   </div>
                               </div>
